...
export function WuQrModal({ isOpen, onClose, server, user }: WuQrModalProps) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full qr-code-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6">
          ...
          <div className="flex space-x-3">
            <button onClick={connectUser} disabled={loading} className="bg-purple-500 hover:bg-purple-600 disabled:opacity-50 text-white px-4 py-3 rounded-lg font-medium transition flex items-center justify-center">
